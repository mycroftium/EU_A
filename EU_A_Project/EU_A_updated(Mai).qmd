...
EU_2014_cleaned <- EU_2014_renamed |> 
  select(
        ...
        w1_q1_, w2_q1_, w3_q1_, w4_q1_, # Barbora's variables
        starts_with("w1_q54_"), starts_with("w1_q56_"),
        starts_with("w1_q68_"), starts_with("w1_q42_"),
        starts_with("w1_q43_"), starts_with("w2_q48_"),
        starts_with("w2_q49_"), starts_with("w2_q39_"),
        starts_with("w2_q40_"), 
        starts_with("w1_q10_"), starts_with("w2_q7_"), # Mai's variables
        starts_with("w3_q11_"), starts_with("w4_q13_"),
        starts_with("w1_q26_"), starts_with("w1_q27_"),
        starts_with("w2_q22_"), starts_with("w2_q23_"),
        starts_with("w3_q28_"), starts_with("w3_q29_"),
        starts_with("w4_q31_"), starts_with("w4_q32_"),
        starts_with("w1_q49_"), starts_with("w2_q44_"),
        starts_with("w3_q43_"), starts_with("w4_q47_"),
        starts_with("w1_q50_"), starts_with("w2_q45_"),
        starts_with("w3_q44_"), starts_with("w1_q51_"),
        starts_with("w2_q46_"), starts_with("w3_q45_"),
        starts_with("w4_q49_"),
        starts_with("w1_q5_"), starts_with("w1_q32_"), # Sara's variables
        starts_with("w1_q34_"), starts_with("w2_q35_"),
        starts_with("w3_q7_"), starts_with("w1_q39_"),
        starts_with("w1_q42_"), starts_with("w2_q39_"),
        starts_with("w1_q61_"), starts_with("w1_q65_"),
        starts_with("w1_q67_")
  )
```
