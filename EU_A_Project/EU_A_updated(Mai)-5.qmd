...
After applying the first the second principle of data tidying, now we come to decide upon the primary keys and foreign keys in each tibbles. We will separate the tibble "EU_2014_cleaned" into two tibbles: "demographic" and "waves"
